...
const PAINTINGS = [
  ...
  },
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:James_Abbott_McNeill_Whistler_-_Nocturne:_Blue_and_Silver_-_Cremorne_Lights_-_Google_Art_Project.jpg",
    license: "Public Domain",
    phase: null,
  ...
  },
  {
    ...
    museumUrl: "https://artuk.org/discover/artworks/nocturne-grey-and-gold-westminster-bridge-86720",
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:James_McNeill_Whistler_-_Nocturne_Grey_and_Gold_-_Westminster_Bridge.jpg",
    license: "Public Domain",
    phase: null,
  ...
  // ─── Van Gogh ────────────────────────────────────────────────────────────
  {
    ...
    museumUrl: "https://www.musee-orsay.fr/en/artworks/vincent-van-gogh-starry-night-354",
  ...
  },
  {
    ...
    museumUrl: "https://www.hermitagemuseum.org/",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Whitehousenight.jpg/1280px-Whitehousenight.jpg",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Vincent_van_Gogh_-_The_White_House_at_Night_-_Hermitage.jpg",
    license: "Public Domain",
  ...
  },
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Van_Gogh%27s_The_Cafe_Terrace_on_the_Place_du_Forum,_Arles,_at_Night,_October_1888.jpg",
    license: "Public Domain",
    phase: null,
    mood: ["still", "warm_gold"],
    palette: "warm_gold",
  ...
  
  {
    ...
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Caspar_David_Friedrich_-_Two_Men_Contemplating_the_Moon_-_Metropolitan.jpg/1280px-Caspar_David_Friedrich_-_Two_Men_Contemplating_the_Moon_-_Metropolitan.jpg",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Caspar_David_Friedrich_-_Two_Men_Contemplating_the_Moon_-_Metropolitan.jpg",
    license: "Public Domain",
  ...
  },
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Caspar_David_Friedrich_019.jpg",
    license: "Public Domain",
  ...
  },
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Caspar_David_Friedrich_-_Mann_und_Frau_in_Betrachtung_des_Mondes_-_Google_Art_Project.jpg",
    license: "Public Domain",
    phase: ["waning_crescent"],
    mood: ["rural", "cold_blue"],
    palette: "cold_blue",
  ...
  // ─── Edvard Munch ────────────────────────────────────────────────────────
  {
    ...
    museumUrl: "https://www.getty.edu/art/collection/object/103RGH",
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Edvard_Munch_-_Starry_Night_-_Google_Art_Project.jpg",
    license: "Public Domain",
    phase: null,
  ...
  // ─── John Atkinson Grimshaw ───────────────────────────────────────────────
  {
    ...
    museumUrl: "https://www.museothyssen.org/",
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Grimshaw_Spirit_of_the_Night.jpg",
    license: "Public Domain",
    phase: ["full"],
    mood: ["rural", "silver"],
    palette: "silver",
  ...
  },
  {
    ...
    museumUrl: "https://commons.wikimedia.org/wiki/Category:John_Atkinson_Grimshaw",
  ...
  },
  {
    ...
    sourceUrl: "https://artuk.org/discover/artworks/reflections-on-the-thames-westminster-london-37665",
    license: "Public Domain",
    phase: null,
  ...
  },
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:John_Atkinson_Grimshaw_-_Moonlit_Lane.jpg",
    license: "Public Domain",
    phase: null,
    mood: ["rural", "silver"],
    palette: "silver",
  ...
  // ─── Ralph Albert Blakelock ───────────────────────────────────────────────
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Brooklyn_Museum_-_Moonlight_Indian_Encampment_-_Ralph_Albert_Blakelock_-_overall.jpg",
    license: "Public Domain",
    phase: ["full"],
    mood: ["warm_gold", "rural"],
    palette: "warm_gold",
  ...
  },
  {
    ...
    museumUrl: "https://www.brooklynmuseum.org/opencollection/objects/1654",
  ...
  // ─── Albert Pinkham Ryder ────────────────────────────────────────────────
  {
    ...
    museumUrl: "https://www.phillipscollection.org/",
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Albert_Pinkham_Ryder_-_Moonlit_Cove.jpg",
    license: "Public Domain",
    phase: null,
    mood: ["silver", "marine"],
    palette: "silver",
  ...
  },
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Albert_Pinkham_Ryder_-_Toilers_of_the_Sea_-_Metropolitan_Museum_of_Art.jpg",
    license: "Public Domain",
    phase: ["full"],
    mood: ["silver", "marine"],
    palette: "silver",
  ...
  // ─── Ivan Aivazovsky ────────────────────────────────────────────────────
  {
    ...
    title: "Moonlit Night on the Black Sea",
    year: 1879,
    medium: "Oil on canvas",
    museum: "Russian Museum, St. Petersburg",
    museumUrl: "https://en.rusmuseum.ru/",
    imageUrl: "https://cdn.gallerix.asia/sr/_EX/1819898631/105767822.jpg",
    sourceUrl: "https://gallerix.org/album/aivazovsky/pic/glrx-105767822",
    license: "Public Domain",
    phase: ["full", "waning_gibbous"],
    mood: ["silver", "marine"],
    palette: "silver",
  ...
  },
  {
    ...
    artist: "Ivan Aivazovsky",
    title: "Night in Crimea. The Moonrise",
    year: 1839,
    medium: "Oil on canvas",
    museum: "Tretyakov Gallery, Moscow",
    museumUrl: "https://www.tretyakovgallery.ru/",
  ...
  // ─── Henry Pether ───────────────────────────────────────────────────────
  {
    ...
    artist: "Henry Pether",
    title: "Moonlight on the Thames near Westminster Bridge",
    year: 1858,
    medium: "Oil on canvas",
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Pether_Henry_Moonlight_on_the_Thames_near_Westminster_Bridge.jpg",
    license: "Public Domain",
    phase: ["full"],
    mood: ["warm_gold", "industrial"],
    palette: "warm_gold",
  ...
  // ─── Hokusai / Hiroshige ─────────────────────────────────────────────────
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Hiroshige_MoonReflection.jpg",
    license: "Public Domain",
    phase: ["full"],
    mood: ["silver", "marine"],
    palette: "silver",
  ...
  },
  {
    ...
    museumUrl: "https://www.metmuseum.org/art/collection/search/55263",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Hiroshige_Man_on_horseback_crossing_a_bridge.jpg/1280px-Hiroshige_Man_on_horseback_crossing_a_bridge.jpg",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Hiroshige_Man_on_horseback_crossing_a_bridge.jpg",
    license: "Public Domain",
    phase: null,
    mood: ["rural", "cold_blue"],
    palette: "cold_blue",
  ...
  },
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Hokusai_Autumn_Moon.jpg",
    license: "Public Domain",
    phase: ["full"],
    mood: ["silver", "rural"],
    palette: "silver",
  ...
  // ─── George Inness ──────────────────────────────────────────────────────
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Moonrise_Inness.jpg",
    license: "Public Domain",
  ...
  // ─── Winslow Homer ──────────────────────────────────────────────────────
  {
    ...
    medium: "Oil on canvas",
    museum: "Metropolitan Museum of Art",
    museumUrl: "https://www.metmuseum.org/art/collection/search/11154",
    imageUrl: "https://collectionapi.metmuseum.org/api/collection/v1/iiif/11127/44025/main-image",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Winslow_Homer_-_Moonlight,_Wood_Island_Light_-_Metropolitan.jpg",
    license: "Public Domain",
    phase: ["full"],
    mood: ["silver", "marine"],
    palette: "silver",
  ...
  // ─── Joseph Wright of Derby ──────────────────────────────────────────────
  {
    ...
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Joseph_Wright_of_Derby_-_Landscape_with_a_Rainbow_-_Google_Art_Project.jpg",
    license: "Public Domain",
    phase: null,
    mood: ["warm_gold", "rural"],
    palette: "warm_gold",
  ...
  // ─── Frederic Edwin Church ───────────────────────────────────────────────
  {
    ...
    museumUrl: "https://collections.sbma.net/objects/11843/moonrise-in-greece",
  ...
  // ─── Jean-François Millet ────────────────────────────────────────────────
  {
    ...
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Starry_Night_by_Jean-Fran%C3%A7ois_Millet.jpeg/1024px-Starry_Night_by_Jean-Fran%C3%A7ois_Millet.jpeg",
